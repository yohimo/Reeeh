...
(function($) {
	...
	_oExt.oPagination = {
		/*
		 * Variable: four_button
		 * Purpose:  Standard two button (forward/back/next/prev) pagination
		...
		"fnInit": function ( oSettings, fnCallbackDraw )
		{
			...
			/*oSettings.nFirst = document.createElement( 'span' );*/
			oSettings.nPrevious = document.createElement( 'span' );
			oSettings.nNext = document.createElement( 'span' );
			/*oSettings.nLast = document.createElement( 'span' );*/
			 
			/*oSettings.nFirst.appendChild( document.createTextNode( oSettings.oLanguage.oPaginate.sFirst ) );*/
			oSettings.nPrevious.appendChild( document.createTextNode( oSettings.oLanguage.oPaginate.sPrevious ) );
			oSettings.nNext.appendChild( document.createTextNode( oSettings.oLanguage.oPaginate.sNext ) );
			/*oSettings.nLast.appendChild( document.createTextNode( oSettings.oLanguage.oPaginate.sLast ) );*/
			 
			oSettings.nFirst.className = "paginate_button first";
			oSettings.nPrevious.className = "paginate_button previous";
			oSettings.nNext.className="paginate_button next";
			oSettings.nLast.className = "paginate_button last";
		...
		"fnUpdate": function ( oSettings, fnCallbackDraw )
		{
			if ( oSettings.iDisplayStart === 0 )
			{
				...
				oSettings.nFirst.className = "paginate_disabled_previous";
			}
			else
			{
				oSettings.nPrevious.className = "paginate_enabled_previous";
				oSettings.nFirst.className = "paginate_enabled_previous";
			}
			...
			if ( oSettings.iDisplayEnd == oSettings.aiDisplay.length )
			{
				...
				oSettings.nLast.className = "paginate_disabled_next";
			}
			else
			{
				oSettings.nNext.className = "paginate_enabled_next";
				oSettings.nLast.className = "paginate_enabled_next";
			}
		}	
		},
		/*
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu":   "<div id=\"rech\"><div class=\"NFSelect\">Affiche par _MENU_",
				"sZeroRecords":  "",
				...
				"oPaginate": {
					/*
					"sFirst":    "<img src=\"images/last.png\" width=\"8\" height=\"9\" />",//Premier
					*/
					"sPrevious": "Precedente",//>Pr&eacute;c&eacute;dent<img src=\"images/prev.png\" width=\"8\" height=\"9\" />
					"sNext":     "Suivante"// />Suivant<img src=\"images/next.png\" width=\"8\" height=\"9\" />
					/*
					"sLast":     "<img src=\"images/next.png\" width=\"8\" height=\"9\" />"//>Dernier
					*/
				}
			};
		...
		this.fnOpen = function( nTr, sHtml, sClass )
		{
			...
			nNewCell.colSpan = _fnVisbleColumns( oSettings )+1;
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input type="text" id="text_rech" onfocus="this.value=\'\'"/>';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = 
				'<select size="1" '+sName+' class="NFSelectRight">'+
